...
#define WRITE_PORT_UCHAR(CONF, PORT, DATA)  (CONF)->pHandler->wu8((CONF)->port + (PORT), (DATA))
#define READ_PORT_UCHAR(CONF, PORT,  PDATA) (CONF)->pHandler->ru8((CONF)->port + (PORT), (PDATA))
